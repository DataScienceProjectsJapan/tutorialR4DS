...
###### This tutorial was written by the following students under the supervision of William Claster at Ritsumeikan Asia Pacific University in Japan as part of a seminar project. To collaborate please contact us.
####### Kamal Al-Tway
####### Dang Ngo
####### Soujanya Dash
####### Yuji Yamaguchi
...
flights %>% group_by(carrier) %>% summarise(mean_ardelay = mean(arr_delay,na.rm = TRUE)) %>% ggplot(aes(x=carrier, y = mean_ardelay, fill = carrier)) + geom_bar(stat = "identity",show.legend = FALSE) + theme_classic()
```
